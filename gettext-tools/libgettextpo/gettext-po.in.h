...
__attribute__ ((visibility ("default"))) extern int libgettextpo_version;

/* ================================= Types ================================= */

/* A po_file_t represents the contents of a PO file.  */
typedef struct __attribute__ ((visibility ("default"))) po_file *po_file_t;

/* A po_message_iterator_t represents an iterator through a domain of a
   PO file.  */
typedef struct __attribute__ ((visibility ("default"))) po_message_iterator *po_message_iterator_t;

/* A po_message_t represents a message in a PO file.  */
typedef struct __attribute__ ((visibility ("default"))) po_message *po_message_t;

/* A po_filepos_t represents a string's position within a source file.  */
typedef struct __attribute__ ((visibility ("default"))) po_filepos *po_filepos_t;

/* A po_error_handler handles error situations.  */
struct __attribute__ ((visibility ("default"))) po_error_handler
{
...
struct __attribute__ ((visibility ("default"))) po_xerror_handler
{
...
__attribute__ ((visibility ("default"))) extern po_file_t po_file_create (void);

/* Read a PO file into memory.
   Return its contents.  Upon failure, return NULL and set errno.  */
#define po_file_read po_file_read_v3
__attribute__ ((visibility ("default"))) extern po_file_t po_file_read (const char *filename,
...
__attribute__ ((visibility ("default"))) extern po_file_t po_file_write (po_file_t file, const char *filename,
                                po_xerror_handler_t handler);

/* Free a PO file from memory.  */
__attribute__ ((visibility ("default"))) extern void po_file_free (po_file_t file);

/* Return the names of the domains covered by a PO file in memory.  */
__attribute__ ((visibility ("default"))) extern const char * const * po_file_domains (po_file_t file);
...
__attribute__ ((visibility ("default"))) extern const char * po_file_domain_header (po_file_t file, const char *domain);

/* Return the value of a field in a header entry.
   The return value is either a freshly allocated string, to be freed by the
   caller, or NULL.  */
__attribute__ ((visibility ("default"))) extern char * po_header_field (const char *header, const char *field);
...
__attribute__ ((visibility ("default"))) extern char * po_header_set_field (const char *header, const char *field, const char *value);
...
/* Create an iterator for traversing a domain of a PO file in memory.
   The domain NULL denotes the default domain.  */
__attribute__ ((visibility ("default"))) extern po_message_iterator_t po_message_iterator (po_file_t file, const char *domain);

/* Free an iterator.  */
__attribute__ ((visibility ("default"))) extern void po_message_iterator_free (po_message_iterator_t iterator);

/* Return the next message, and advance the iterator.
   Return NULL at the end of the message list.  */
__attribute__ ((visibility ("default"))) extern po_message_t po_next_message (po_message_iterator_t iterator);
...
/* Insert a message in a PO file in memory, in the domain and at the position
   ...
   inserted message.  */
__attribute__ ((visibility ("default"))) extern void po_message_insert (po_message_iterator_t iterator, po_message_t message);
...
__attribute__ ((visibility ("default"))) extern po_message_t po_message_create (void);

/* Return the context of a message, or NULL for a message not restricted to a
   context.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_msgctxt (po_message_t message);

/* Change the context of a message. NULL means a message not restricted to a
   context.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_msgctxt (po_message_t message, const char *msgctxt);

/* Return the msgid (untranslated English string) of a message.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_msgid (po_message_t message);

/* Change the msgid (untranslated English string) of a message.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_msgid (po_message_t message, const char *msgid);

/* Return the msgid_plural (untranslated English plural string) of a message,
   or NULL for a message without plural.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_msgid_plural (po_message_t message);

/* Change the msgid_plural (untranslated English plural string) of a message.
   NULL means a message without plural.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_msgid_plural (po_message_t message, const char *msgid_plural);

/* Return the msgstr (translation) of a message.
   Return the empty string for an untranslated message.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_msgstr (po_message_t message);

/* Change the msgstr (translation) of a message.
   Use an empty string to denote an untranslated message.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_msgstr (po_message_t message, const char *msgstr);
...
__attribute__ ((visibility ("default"))) extern const char * po_message_msgstr_plural (po_message_t message, int index);
...
__attribute__ ((visibility ("default"))) extern void po_message_set_msgstr_plural (po_message_t message, int index, const char *msgstr);

/* Return the comments for a message.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_comments (po_message_t message);

/* Change the comments for a message.
   comments should be a multiline string, ending in a newline, or empty.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_comments (po_message_t message, const char *comments);

/* Return the extracted comments for a message.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_extracted_comments (po_message_t message);

/* Change the extracted comments for a message.
   comments should be a multiline string, ending in a newline, or empty.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_extracted_comments (po_message_t message, const char *comments);

/* Return the i-th file position for a message, or NULL if i is out of
   range.  */
__attribute__ ((visibility ("default"))) extern po_filepos_t po_message_filepos (po_message_t message, int i);

/* Remove the i-th file position from a message.
   The indices of all following file positions for the message are decremented
   by one.  */
__attribute__ ((visibility ("default"))) extern void po_message_remove_filepos (po_message_t message, int i);
...
__attribute__ ((visibility ("default"))) extern void po_message_add_filepos (po_message_t message, const char *file, size_t start_line);

/* Return the previous context of a message, or NULL for none.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_prev_msgctxt (po_message_t message);

/* Change the previous context of a message.  NULL is allowed.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_prev_msgctxt (po_message_t message, const char *prev_msgctxt);

/* Return the previous msgid (untranslated English string) of a message, or
   NULL for none.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_prev_msgid (po_message_t message);

/* Change the previous msgid (untranslated English string) of a message.
   NULL is allowed.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_prev_msgid (po_message_t message, const char *prev_msgid);

/* Return the previous msgid_plural (untranslated English plural string) of a
   message, or NULL for none.  */
__attribute__ ((visibility ("default"))) extern const char * po_message_prev_msgid_plural (po_message_t message);

/* Change the previous msgid_plural (untranslated English plural string) of a
   message.  NULL is allowed.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_prev_msgid_plural (po_message_t message, const char *prev_msgid_plural);

/* Return true if the message is marked obsolete.  */
__attribute__ ((visibility ("default"))) extern int po_message_is_obsolete (po_message_t message);

/* Change the obsolete mark of a message.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_obsolete (po_message_t message, int obsolete);

/* Return true if the message is marked fuzzy.  */
__attribute__ ((visibility ("default"))) extern int po_message_is_fuzzy (po_message_t message);

/* Change the fuzzy mark of a message.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_fuzzy (po_message_t message, int fuzzy);

/* Return true if the message is marked as being a format string of the given
   type (e.g. "c-format").  */
__attribute__ ((visibility ("default"))) extern int po_message_is_format (po_message_t message, const char *format_type);

/* Change the format string mark for a given type of a message.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_format (po_message_t message, const char *format_type, /*bool*/int value);

/* If a numeric range of a message is set, return true and store the minimum
   and maximum value in *MINP and *MAXP.  */
__attribute__ ((visibility ("default"))) extern int po_message_is_range (po_message_t message, int *minp, int *maxp);
...
/* Change the numeric range of a message.  MIN and MAX must be non-negative,
   ...
   message.  */
__attribute__ ((visibility ("default"))) extern void po_message_set_range (po_message_t message, int min, int max);


/* =========================== po_filepos_t API ============================ */

/* Return the file name.  */
__attribute__ ((visibility ("default"))) extern const char * po_filepos_file (po_filepos_t filepos);

/* Return the line number where the string starts, or (size_t)(-1) if no line
   number is available.  */
__attribute__ ((visibility ("default"))) extern size_t po_filepos_start_line (po_filepos_t filepos);


/* ============================ Format type API ============================= */

/* Return a NULL terminated array of the supported format types.  */
__attribute__ ((visibility ("default"))) extern const char * const * po_format_list (void);
...
__attribute__ ((visibility ("default"))) extern const char * po_format_pretty_name (const char *format_type);
...
__attribute__ ((visibility ("default"))) extern void po_file_check_all (po_file_t file, po_xerror_handler_t handler);
...
__attribute__ ((visibility ("default"))) extern void po_message_check_all (po_message_t message, po_message_iterator_t iterator, po_xerror_handler_t handler);
...
__attribute__ ((visibility ("default"))) extern void po_message_check_format (po_message_t message, po_xerror_handler_t handler);
